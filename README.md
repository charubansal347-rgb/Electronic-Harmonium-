...
Project Overview
This project is a electronic harmonium designed using a 555 timer IC and a resistor network. Instead of mechanical keys, copper pads on a custom PCB are played using a metal probe. When the probe touches a pad, a corresponding musical note is produced through a speaker.
...
How to Use
Connect the 9V battery to the PCB.
Connect the speaker to the output terminals.
Touch any copper pad using your finger.
The corresponding musical note will be heard.
Release the pad to stop the sound.
Code / Programming
